...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "SoKKBh6tAEQRTKCs9A7mNkmtl", consumerSecret: "pQLyiD7OH6MZco3ucWVQkQ5g2ZauU4phmar0qIIki9WVhj9Fwp")
    var loginSuccess: (() -> ())?
    ...
    func likeTweet(tweetId: Int, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
    ...
    func unlikeTweet(tweetId: Int, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
